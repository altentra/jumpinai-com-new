      ...
      html: `
        <div style="max-width: 600px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #1f2937;">
          ...
          <div style="background: linear-gradient(135deg, #3b82f6 0%, #8b5cf6 100%); padding: 32px 28px; text-align: center; border-radius: 8px 8px 0 0;">
            <h1 style="color: #ffffff; margin: 0; font-size: 28px; font-weight: 700; letter-spacing: -0.5px;">${isResubscription ? 'Welcome Back to JumpinAI' : 'Welcome to JumpinAI'}</h1>
            <p style="color: #ffffff; margin: 12px 0 0 0; font-size: 16px; font-weight: 400;">Your AI transformation journey ${isResubscription ? 'continues' : 'begins now'}</p>
          </div>
