...
const testimonials: Testimonial[] = [
  {
    ...
    location: "Denver, CO",
    quote: "I described what I wanted to achieve and what was holding me back — that's it. Two inputs. The Jump I got back had a full phased plan I could actually follow. I clarified two steps down to sub-steps, rerouted one that didn't fit my team's setup, and ended up building an AI agent directly from the plan. We went from zero AI to a live automated workflow in under a week.",
    highlight: "Zero to live AI agent in days",
    avatar: "DK",
  },
  {
    name: "Samira E.",
    ...
    location: "Toronto, ON",
    quote: "I'd been stuck for months trying to figure out which AI tools actually fit my work. The Jump gave me 9 tool-prompt combos tailored to my exact situation — not generic suggestions, real combos with ready-to-use prompts. Then I explored alternative routes on a step that felt off, picked a better direction, and the whole plan adjusted. It's like having a strategist who actually listens.",
    highlight: "9 tailored tool-prompt combos",
    avatar: "SE",
  },
  {
    name: "Jason M.",
    role: "Agency Founder",
    location: "Atlanta, GA",
    quote: "The plan step alone was worth it — phased, clear, and I could drill into any step four levels deep with clarifications. But what sold me was the implementation side. I analyzed my Jump, picked the opportunities that mattered most, and built two automated workflows on Make.com straight from the platform. My team now runs processes that used to take half a day in under ten minutes.",
    highlight: "Half-day processes in 10 min",
    avatar: "JM",
  },
];
