...
const testimonials: Testimonial[] = [
  {
    ...
    location: "Phoenix, AZ",
    quote: "I'm 54 and I felt like the world was leaving me behind. Everyone around me was talking about AI and I didn't even know what half the tools were. I found JumpinAI, typed in what I actually do every day and what frustrates me — and it just... made sense of it all. Gave me a clear path. I followed it, and now my small firm operates like it has twice the staff. My daughter says I sound like a tech guy now. I'm not. I just finally had someone meet me where I was.",
    highlight: "Finally caught up",
    avatar: "MP",
  },
  {
    name: "Leah T.",
    ...
    quote: "Honestly? I almost didn't try it. I've been burned by so many 'AI solution' platforms that promise the world and deliver a PDF. But this was different. It didn't just say 'use ChatGPT' — it gave me a strategy that actually fit the way I work. I explored a couple of different directions before landing on one that clicked, and now I pitch AI-integrated brand strategies to clients. That's a service I literally didn't offer three months ago.",
    highlight: "Created a whole new service",
    avatar: "LT",
  },
  {
    name: "Andre W.",
    ...
    location: "Houston, TX",
    quote: "I run a landscaping company. Not exactly the first industry you think of with AI. But I was drowning in admin — quoting, scheduling, follow-ups. The plan I got was so specific to my actual problems that I thought someone had looked at my business. I ended up building two automations through the platform that handle things I used to spend every Sunday night doing. Got my weekends back. That's not a small thing when you have kids.",
    highlight: "Got his Sundays back",
    avatar: "AW",
  },
];
