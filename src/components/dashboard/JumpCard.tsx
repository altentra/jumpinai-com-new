    ...
    >
      ...
      <CardContent className="pt-0 relative z-10 space-y-4">
        ...
        <div className="relative group/btn">
          ...
          <Button 
            className="w-full relative overflow-hidden rounded-full bg-gradient-to-br from-background/95 via-background/90 to-background/85 dark:from-background/98 dark:via-background/95 dark:to-background/90 backdrop-blur-xl border border-primary/25 hover:border-primary/40 shadow-xl hover:shadow-2xl hover:shadow-primary/25 transition-all duration-500 hover:scale-[1.02] font-bold text-foreground h-12"
            onClick={(e) => {
              e.stopPropagation();
              navigate(`/dashboard/jump/${jump.id}`);
            }}
