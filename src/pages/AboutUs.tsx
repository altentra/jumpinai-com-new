            ...
            <div className="grid md:grid-cols-[1fr_1.5fr] gap-8 md:gap-12 items-center">
              ...
              <div className="flex flex-col items-center space-y-5">
                <div className="relative group">
                  ...
                  {/* Founder photo */}
                  <div className="relative w-36 h-36 sm:w-44 sm:h-44 rounded-2xl overflow-hidden border border-primary/25 shadow-xl shadow-primary/15 group-hover:border-primary/40 transition-all duration-500">
                    <img 
                      src={founderImg} 
