      ...
      <Card className="glass border-primary/20 animate-fade-in-up rounded-2xl shadow-modern hover:shadow-modern-lg transition-all duration-300">
        <CardContent className="p-6 sm:p-8 text-center">
          ...
          <Button 
            ...
            className="glass hover:bg-foreground/10 hover:scale-[1.02] px-5 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-semibold rounded-2xl transition-all duration-300 shadow-modern hover:shadow-modern-lg group w-full sm:w-auto"
          >
