...
const freeBlueprints: Blueprint[] = [
  ...
  { 
    name: "Meeting Action Template", 
    whatItIs: "Structured template for transforming meetings into actionable outcomes",
    whatItsFor: "Converting meeting discussions into clear action items and follow-ups", 
    desiredOutcome: "Organized action items with clear ownership and timelines",
...
const proBlueprints: Blueprint[] = [
  { 
    ...
    whatItIs: "Comprehensive strategic planning template for business development",
    whatItsFor: "Creating detailed business strategies with actionable implementation plans", 
    desiredOutcome: "Complete strategic roadmap with clear objectives and success metrics",
    template: "# Strategic Business Plan\n## Executive Summary\n## Market Analysis\n## Competitive Positioning\n## Growth Strategy\n## Resource Allocation\n## Success Metrics\n## Risk Mitigation", 
    topicCategory: "Text",
